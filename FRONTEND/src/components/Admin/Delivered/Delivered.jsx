  ...
  return (
    <div  className='h-[100%] w-[100%] bg-blue-200 ' >
       <div>
        ...
        <h1 className='font-bold mt-8 ml-8  text-blue font-cerebriSans text-blue-900 co text-5xl'>Customer Order Delivered</h1>
        <h5 className='text-black      ml-10  '>This product has been Delivered</h5>
