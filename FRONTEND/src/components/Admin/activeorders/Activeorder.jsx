...
function Activeorder() {
  return (
    ...
    <div>
        ...
        <h1 className='font-bold mt-8 ml-8  text-blue font-cerebriSans text-blue-900 co text-5xl'>Customer Order Active</h1>
        <h5 className='text-black      ml-10  '>This product is under Deliver</h5>
